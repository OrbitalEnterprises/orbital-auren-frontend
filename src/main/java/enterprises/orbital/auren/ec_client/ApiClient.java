...
import enterprises.orbital.auren.ec_client.auth.ApiKeyAuth;
import enterprises.orbital.auren.ec_client.auth.Authentication;
import enterprises.orbital.auren.ec_client.auth.HttpBasicAuth;
import enterprises.orbital.auren.ec_client.auth.OAuth;
...
public class ApiClient {
  ...
  private String                      basePath         = "http://api.eve-central.com/api";
   ...
   * 
   * @param userAgent
   *          user agent header to set
   * @return ApiClient with user agent set
   */
   ...
   * @param value
   *          The header's value
   * @return ApiClient with added header
   */
   ...
   * @return ApiClient with debugging set as required
   */
   ...
   * @param dateFormat
   *          date format to set
   * @return ApiClient with date format set
   */
   ...
   * @param str
   *          String to parse
   * @return Date representing parsed string
   */
   ...
   * @param date
   *          date to convert
   * @return String conversion of date
   */
   ...
   * @param param
   *          object to format
   * @return String formatting of object
   */
   ...
   *          Object to serialize
   * @param contentType
   *          content type to guide serialization
   ...
   * 
   * @param response
   *          Client response to deserialize
   * @param returnType
   *          Expected return type
   * @param <T>
   *          type result will be cast to
  ...
  public <T> T deserialize(ClientResponse response, TypeRef returnType) throws ApiException {
    ...
    if (contentTypes != null && !contentTypes.isEmpty()) contentType = contentTypes.get(0);
  ...
  private ClientResponse getAPIResponse(
    ...
    if (body != null && binaryBody != null) { throw new ApiException(500, "either body or binaryBody must be null"); }
   ...
   * @throws ApiException
   *           if exception occurs during invocation
   */
  public <T> T invokeAPI(
                         ...
                         String contentType,
                         String[] authNames,
                         @SuppressWarnings("rawtypes") TypeRef returnType) throws ApiException {
   ...
   * 
   * @param formParams
   *          form parameters to encode
   * @return String encoding of form parameters
   */
